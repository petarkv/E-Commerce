<html>
    ...
    <body>
        <table width='700px'>
            <tr><td>&nbsp;</td></tr> 
            <tr><td><img src="{{ asset('/images/main_images/myshop_logo.png') }}"></td></tr> 
            <tr><td>&nbsp;</td></tr> 
            <tr><td>Hello {{ $name }} {{ $surname }},</td></tr>
            <tr><td>&nbsp;</td></tr>
                ...
                <table width='95%' cellpadding="5" cellspacing="5" bgcolor="#e0d9d9">
                    ...
                    @foreach($productDetails['orders'] as $product)
                        <tr>
                            ...
                            <td>EUR {{ $product['product_price'] }}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td colspan="5" align="right">Shipping Charges</td><td>EUR {{ $productDetails['shipping_charges'] }}</td>
                    </tr>
                    <tr>
                        <td colspan="5" align="right">Coupon Discount</td><td>EUR {{ $productDetails['coupon_amount'] }}</td>
                    </tr>
                    <tr>
                        <td colspan="5" align="right">Grand Total</td><td>EUR {{ $productDetails['grand_total'] }}</td>
                    </tr>
                </table>
            </td></tr>
            <tr><td>
