              ...
              <form class="form-horizontal" method="post" action="{{ url('/admin/edit-product/'.$productDetails->id) }}" 
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      src="{{ asset('/images/template_images/products/small/'.$productDetails->image) }}">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="checkbox" name="feature_item" id="feature_item" @if($productDetails->feature_item==1) checked @endif
                    value="1">
                  </div>
                </div>
