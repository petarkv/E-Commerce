...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom">
          <i class="icon-home"></i> Home</a> <a href="{{ url('/admin/view-products') }}">Product's Images</a> 
          <a href="" class="current">Add Product Images</a> </div>
      <h1>Product's Images</h1>
                ...
                <tbody>
                  @foreach ($productsImages as $image)
                      <tr>
                        ...
                        <td><img src="{{ asset('images/template_images/products/small/'.$image->image) }}"
                          style="width: 60px; height: 60px;"></td>
                        <td><a rel="{{ $image->id }}" rel1="delete-alt-image" 
                          href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Product Image">Delete</a></td>
                      </tr>
                  @endforeach
                </tbody>
              </table>
